...
<div id="hidemsgsession">
    ...
    <div style=" width: 70%; margin:auto; background:white; padding:35px; ">
        ...
        <p class="alert alert-dark" style="font-size:22px;">Student Information   
        <a href="addstudents.php"><button class="bg-dark" style="color:white; float:right; margin-right:15px;">Add New Student</button></a>
    </p>
        ...
        <form action="" method="post">
           <input type="text" name="searchtrainer" id="searchtrainer" placeholder="Enter ID/ name to Search" style="width:40%; padding:5px">
                        ...
                        <button name="btnsearch" class="btn btn-primary">Search Student</button>
                        &emsp; <button name="viewall" class="btn btn-success">Show All Students</button>
        ...
        <table class='table table-striped'>
            ...
            <?php include "../db/admin/dbviewstudents.php"; ?>

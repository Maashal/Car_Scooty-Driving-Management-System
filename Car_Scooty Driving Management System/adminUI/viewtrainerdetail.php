...
<body>
    ...
    <div style="padding:15px; width:65%; margin:auto; box-shadow: 0px 0px 15px 0px grey;">
        ...
        echo "<a href='updatetrainerprofile.php?update=" . $trainerid . "'><button class='btn btn-success' style='width:45%;'>Update</button></a> &emsp;
        <a href='../db/admin/dbdeletetrainer.php?delete=" . $trainerid . "'><button class='btn btn-danger' style='width:45%;'>Delete</button></a>";

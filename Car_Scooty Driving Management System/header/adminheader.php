...
<body>
    ...
    <div id="divnav">
        <!-- creating home icone -->
        <a href="adminhome.php" style="color:black" > <i class="fa fa-home" ></i></a>

        
        <a href="viewbookinghistory.php" class="links"> View Booking </a>
        <a href="managetrainer.php"  class="links"> Manage Trainer</span></a>
        <a href="managestudents.php"  class="links"> Manage Students</a>
        <a href="managepackages.php"  class="links"> Manage Packages</a>

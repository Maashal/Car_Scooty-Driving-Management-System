...
<body>
    ...
    if (isset($_REQUEST['search'])) {
        ...
        header("Location: searchtrainer.php?searchtrd=adfadsfasf&searchtxt=$searchtext1&optiondrp=$optiondropdown1");
    }
    ?>
    ...
    <div id="divnav">
        <!-- creating home icone -->
        <a href="../index.php" style="color:black"> <i class="fa fa-home" style="font-size:60px;"></i><span style="font-size:30px;">&nbsp;<b> Home</b></span></a>

        <div id="divinnav">
            <form method="post">

               <span style="font-size:22px;"> <b>Search &nbsp;</b></span><input type="text" name="searchtxt" class="navc" id="inputfieldsearch" required="required" placeholder="Enter Text to Search" size="40">
                ...
                &emsp;
                <button type="submit" name="search" id="linkbtnsearch" class="navc"><i class="fa fa-search" style="font-size:40px;"></i></button>

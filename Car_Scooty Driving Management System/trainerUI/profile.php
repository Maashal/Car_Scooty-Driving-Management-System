...
<body>
    ...
    <div style="padding:20px; width:65%; margin:auto;">
        ...
        <div id="divleft">
            ...
            <a href="profile.php?updateprofile=12312ml21421&trainerid=<?php echo $trainerid; ?>"><button class="btn-info btnup">Update Profile</button></a>

            <hr>
            <h3 style="text-align:left; padding-left:15px;"><u>Detail</u></h3>
         
            <p style="text-align:justify; padding-left:15px;"><?php
                echo  $srdetail;
                ?>
            </p>
        ...
        <div class="divright">
            ...
            <table class="table table-borderedless">
                ...
                <tr>
                    <td id="col1">Vehicle Training Offers</td>
                    <td><?php echo $vdetail; ?></td>
                </tr>

                <tr>
                    <td id="col1">Experience</td>
                    <td><?php echo $exprnce. " Years"; ?></td>
                </tr>
